...
execute @s[scores={detect_ground=0,detect_glide=0,detect_levitate=0}] ~ ~ ~ detect ~ ~-1 ~ air 0 scoreboard players add @s inair 1
...
#Server Saftey Stats
execute @e[type=polar:settings,tag=!fly] ~ ~ ~ scoreboard players add @s safetyscore 4
tag @e[type=polar:settings] add fly